...
class Invoice(Base):
    ...
    client_tax_id_snapshot = Column(String(50), nullable=True)
    subtotal_snapshot = Column(Numeric(12, 2), nullable=True)
    igi_amount_snapshot = Column(Numeric(12, 2), nullable=True)
    total_snapshot = Column(Numeric(12, 2), nullable=True)
    payment_terms_days_applied = Column(Integer, nullable=True)
    igi_rate_snapshot = Column(Numeric(5, 2), nullable=True)
